...
export default function TrendingSidebar({ items }) {
  ...
  return (
    <aside className="hidden xl:flex flex-col gap-3 w-60 flex-shrink-0 sticky top-4 self-start">
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
        ...
        <div className="divide-y divide-slate-100">
          {items.map((t, i) => (
            ...
            >
              <span
                className={`text-xl font-black leading-none flex-shrink-0 pt-0.5 ${i < 3 ? "text-red-600" : "text-slate-200"}`}
              >
